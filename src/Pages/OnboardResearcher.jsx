...
export default function OnboardResearcher() {
  ...
  async function handleOAuthComplete() {
    ...
    if (researchInterests.length < 5) {
      setError("Please add at least 5 research interests/keywords");
      setLoading(false);
      return;
    }
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <p className="text-[10px]" style={{ color: "#787878" }}>
                      ...
                      {step === 2 &&
                        "Share your specialty and research interests (at least 5 keywords)"}
                  ...
                  >
                    ...
                    <div className="space-y-1.5">
                      ...
                      {researchInterests.length < 5 && (
                        <p className="text-[9px]" style={{ color: "#DC2626" }}>
                          {5 - researchInterests.length} more required
                        </p>
                      )}
                    </div>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-1.5">
                            <Input
                              ...
                              className="text-xs py-1 px-2 border rounded-lg"
                              style={{
                                borderColor: "#E8E8E8",
                                color: "#2F3C96",
                              }}
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex gap-1.5">
                        <Input
                          ...
                          className="flex-1 py-1.5 px-2.5 text-xs border rounded-lg"
                          style={{
                            borderColor: "#E8E8E8",
                            color: "#2F3C96",
                          }}
