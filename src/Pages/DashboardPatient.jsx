      ...
      const fetchData = async () => {
        ...
        try {
          ...
          if (!response.ok) {
            ...
            // Batch simplify publication titles
          ...
          try {
            ...
            if (favResponse.ok) {
              ...
              // Batch simplify publication titles in favorites
              ...
              if (favoritePublicationTitles.length > 0) {
                fetch(`${base}/api/ai/batch-simplify-titles`, {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify({ titles: favoritePublicationTitles }),
                })
                  .then((res) => res.json())
                  .then((data) => {
                    const simplifiedTitles = data.simplifiedTitles || [];
                  ...
                  .catch((error) => {
                    console.error("Error batch simplifying favorite publication titles:", error);
                  });
              }

              // Batch simplify trial titles in favorites
              ...
              if (favoriteTrials.length > 0) {
                const favoriteTrialObjects = favoriteTrials.map((fav) => fav.item);
                fetch(`${base}/api/ai/batch-simplify-trial-summaries`, {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  ...
                  .then((data) => {
                    ...
                    setSimplifiedTrialSummaries((prev) => {
                      ...
                      favoriteTrials.forEach((fav, index) => {
                        if (simplifiedSummaries[index]) {
                          newMap.set(fav.item.title, simplifiedSummaries[index]);
                        }
                      });
                      return newMap;
                    });
                  ...
                  .catch((error) => {
                    console.error("Error batch simplifying favorite trial summaries:", error);
                  });
              }
            }
          } catch (error) {
