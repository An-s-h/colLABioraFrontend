  ...
  useEffect(() => {
    async function syncUserWithBackend() {
      ...
      try {
        ...
        // Check if this is a new user from sign-in flow who needs to complete profile
        ...
        // Store JWT token and user data (existing user or sign-up flow with onboarding)
        if (data.token) {
        ...
        if (data.isNewUser && !onboardingData) {
          // New OAuth user without onboarding data - ask them to complete profile
          // Store minimal data and redirect to role selection
          navigate("/auth/complete-profile");
          return;
        }
