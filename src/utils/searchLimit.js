 ...
 * 
 * This utility tracks search counts in local storage for immediate UI feedback,
 * while the backend enforces the limit via IP address.
 * 
 * The frontend and backend should stay in sync, but the backend is the source of truth.
 */
